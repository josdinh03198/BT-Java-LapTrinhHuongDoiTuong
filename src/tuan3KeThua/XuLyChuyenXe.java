...
public class XuLyChuyenXe {
	public static String tieuDe1()
	{
		String s="";
		s+=String.format("%8s%30s%8s%9s%8s%30s","Mã Xe","Họ tên TX","Số Xe","Doanh Thu","Số KM","Số Tuyến");
		return s;
	}
	public static String tieuDe2()
	{
		String s="";
		s+=String.format("%8s%30s%8s%9s%30s%5s","Mã Xe","Họ tên TX","Số Xe","Doanh Thu","Nơi đến","Số ngày");
		return s;
	}
	...
	public static ChuyenXe themChuyenXe()
	{
		...
		try
		{
			...
			case 1:// nội thành
					...
					x = new ChuyenXeNoiThanh(maXe,hoTenTX,soXe,doanhThu,soTuyen,soKM);
					break;
			case 2://ngoại thành
				...
				soNgay= scn.nextInt();
				x = new ChuyenXeNoiThanh(maXe,hoTenTX,soXe,doanhThu,noiDen,soNgay);
				break;
			}
	...
	public static void nhapCung(DanhSachChuyenXe dsCx)
	{
		...
		ChuyenXe cx= new ChuyenXeNoiThanh("002","Nguyễn Lương Đạt","29732",500000,"TP.HCM-HN",1500);
		dsCx.themCX(cx);
		
		ChuyenXe cx1= new ChuyenXeNoiThanh("001","Lý Huy Vân","29103",1000000,"TP.HCM-BD",500);
		dsCx.themCX(cx1);
	...
	public static void main(String[] args) {
		...
		while(choise!=0)
		{
			...
			case 2: 
				xuat(dsCx.getAllCX());
				break;
			case 3: System.out.println("Doanh Thu Chuyến Xe Nội Thành" +dsCx.tongDThuNoiThanh());
